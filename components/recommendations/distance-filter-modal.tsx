...
/**
 * Modal component for filtering recommendations by city and maximum distance.
 * Allows users to select a city (which triggers a refetch) and maximum distance in kilometers for filtering place recommendations.
 *
