...
/**
 * Modal component for filtering recommendations by open now status.
...
export function OpenNowFilterModal({
  ...
  const { filterOpenNow, setFilterOpenNow, fetchRecommendations } =
    useRecommendations();
  ...
  const handleSave = useCallback(async () => {
    ...
    if (location) {
      fetchRecommendations(location, true, selectedFilter);
    }
    onClose();
  }, [
    selectedFilter,
